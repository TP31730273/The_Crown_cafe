...
//   back to menu 
  $('.back-to-menu').click(function () {
      console.log("helo")
    $('.changing-menu').html(`<div class="changing-menu">
    <div class="row" data-aos="fade-up" data-aos-delay="100">
      <div class="col-lg-12 d-flex justify-content-center text-capitalize">
        <ul id="menu-flters">
          <li class="click-bev">beverages</li>
          <li class="click-snak">snakes</li>
          <li class="click-starter">starter</li>
          <li class="click-meals">meal's</li>
        </ul>
      </div>
    </div>
  </div>`)
